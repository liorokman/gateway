...
func (in *HTTP1Settings) DeepCopyInto(out *HTTP1Settings) {
	*out = *in
	if in.RequestHeadersCase != nil {
		in, out := &in.RequestHeadersCase, &out.RequestHeadersCase
		*out = new(bool)
		**out = **in
	}
	if in.ResponseHeadersCase != nil {
		in, out := &in.ResponseHeadersCase, &out.ResponseHeadersCase
		*out = new(bool)
		**out = **in
	}
